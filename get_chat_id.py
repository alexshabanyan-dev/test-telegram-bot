...
async def get_chat_id():
    ...
    try:
        ...
        print("="*60)
        print(f"\n1️⃣  Ваш личный чат (Saved Messages):")
        print(f"   NOTIFY_CHAT_ID={me.id}")
        
        print(f"\n2️⃣  Отправьте сообщение боту @userinfobot в Telegram")
        print(f"   Он покажет ваш chat_id")
        
        print(f"\n3️⃣  Создайте бота через @BotFather и отправьте ему /start")
        print(f"   Затем используйте его chat_id")
        
        print(f"\n4️⃣  Используйте другой канал/чат:")
